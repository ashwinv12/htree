 ...
 * 	TTreeWindow
 * 
 * 		A window with a centered TTree
 * 
 **************************************************************/
...
public class TTreeWindow extends JFrame implements MouseListener {
	 ...
	 * @param depth - recursive depth of the TTree
	 */
	...
	/**
	 * main
	 * 		create an TTree window with an appropriate recursive depth
	 * 
	...
	/**
	 * incrementDepth
	 * 		increase the depth of the TTree, up to a point
	 */
